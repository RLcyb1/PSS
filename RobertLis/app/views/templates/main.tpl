...
<head>
    ...
    <title>{block name="title"}Twój Budżet Domowy{/block}</title>
...
<body class="d-flex flex-column min-vh-100">
    ...
    {else}
        <li class="nav-item">
            <a class="nav-link" href="{$conf->action_root}login">Zaloguj się</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="{$conf->action_root}register">Załóż konto </a>
        </li>
    {/if}
</ul>
                    </div>
